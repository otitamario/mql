...
class CTrailing
{
	...
	public:
		...
		bool BreakEven(string pSymbol,bool usarbreak,int &pBreakEven[],int &pLockProfit[]);
};
...
// Break even stop
bool CTrailing::BreakEven(string pSymbol,bool usarbreak,int &pBreakEven[],int &pLockProfit[])
{
