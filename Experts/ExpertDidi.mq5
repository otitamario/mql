...
//--- available signals
#include <Expert\Signal\SignalDIDI.mqh>
//--- available trailing
...
//+------------------------------------------------------------------+
//--- inputs for expert
input string             Expert_Title         ="ExpertDidi"; // Document name
ulong                    Expert_MagicNumber   =14957;        // 
...
input double             Signal_DIDI_Weight   =1.0;          // DIDI Index Weight [0...1.0]
//--- inputs for trailing
...
//--- Creating filter CSignalDIDI
   CSignalDIDI *filter0=new CSignalDIDI;
   if(filter0==NULL)
     {
      //--- failed
...
//--- Set filter parameters
   filter0.Weight(Signal_DIDI_Weight);
